...
import task4.object.Const;
import task4.object.Variable;
import task4.operation.checked.*;
...
public class ExpressionParser implements Parser {
    ...
    private TripleExpression operand() throws FormatParserException {
        ...
        if (len == firstIndex) {
            ...
            throw new FormatParserException("Expected argument, found end of task4.expression at index " + (firstIndex - 1) +
                    "\n\t"
